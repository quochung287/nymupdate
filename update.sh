...
function upgrade_nym () {
     ...
     printf '%s\n' "ExecStart=/home/nym/nym-mixnode_linux_x86_64 run --id LN" >> /etc/systemd/system/nym-mixnode.service
    ...
    cd /home/nym/
    sudo -u nym -H ./nym-mixnode_linux_x86_64 upgrade --id /home/nym/.nym/mixnodes/LN    
}
#set -x
